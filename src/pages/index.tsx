          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="block text-emerald-300">Cannabis Compliance</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/demo" className="inline-flex items-center justify-center px-8 py-4 bg-white text-emerald-900 font-semibold rounded-lg hover:bg-emerald-50 transition-colors">
      ...
      <section className="py-20 bg-emerald-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-emerald-300">99.99%</div>
              <div className="text-emerald-100">Guaranteed Uptime</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-emerald-300">50+</div>
              <div className="text-emerald-100">Multi-State Operators</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-emerald-300">SOC 2</div>
              <div className="text-emerald-100">Type II Certified</div>
            </div>
          </div>
        </div>
      </section>
